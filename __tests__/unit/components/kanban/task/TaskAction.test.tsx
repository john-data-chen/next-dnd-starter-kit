...
vi.mock('@/components/kanban/task/TaskForm', () => ({
  TaskForm: (props: any) => <form data-testid="task-form" onSubmit={e => { e.preventDefault(); props.onSubmit && props.onSubmit({ title: 't', status: 'TODO' }); }}>{props.submitLabel}</form>
}));
...
vi.mock('@/components/ui/dropdown-menu', () => ({
  ...
  DropdownMenuItem: (props: any) => <div data-testid="dropdown-menu-item" onClick={props.onSelect}>{props.children}</div>,
