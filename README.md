...
- status: enabled
- benefit: Significantly faster (about 45~50 times) than Prettier, with near-instant cold startup times.(it can format this small project in 13ms, it has more potential in big projects with thousands of files) Aims for ~99.99% compatibility with Prettier to make migration easy.
