...
- After I enabled new rules of Oxlint and Type-Aware plug-in, linter finds more code smells in the project, but errors of linter are not issues, no effect in functional.
